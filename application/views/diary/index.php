...
<div class="main_container">
	...
	<div class="main_content">
		...
		<div class="datagrid_container">
			...
			<div class="datagrid_wrapper" style="grid-template-columns: 100px 1fr 1fr auto auto; column-gap: 5px;">
				...
				foreach($records as $row)
				{
					...
					echo "<div class='c_p' style='display: contents' title='Click to view diary bookings' onclick='diary.selectDiary($row->uid)'>";
